...
public interface AccountEntryPersistence extends BasePersistence<AccountEntry> {
	 ...
	 * @return the matching account entry, or <code>null</code> if a matching account entry could not be found
	 */
	public default AccountEntry fetchByERC_C(
		String externalReferenceCode, long companyId) {
	 ...
	 */
	public default java.util.List<AccountEntry> findByUuid(String uuid) {
		return findByUuid(
	 ...
	 */
	public default java.util.List<AccountEntry> findByUuid(
		String uuid, int start, int end) {
	 ...
	 */
	public default java.util.List<AccountEntry> filterFindByUuid(String uuid) {
	 ...
	 */
	public default java.util.List<AccountEntry> filterFindByUuid(
		String uuid, int start, int end) {
	 ...
	 * @return the matching account entries
	 */
	public default java.util.List<AccountEntry> findByUuid_C(
		String uuid, long companyId) {
	 ...
	 * @return the matching account entries that the user has permission to view
	 */
	public default java.util.List<AccountEntry> filterFindByUuid_C(
		String uuid, long companyId) {
	 ...
	 * @return the matching account entries
	 */
	public default java.util.List<AccountEntry> findByCompanyId(
		long companyId) {
	 ...
	 * @return the matching account entries that the user has permission to view
	 */
	public default java.util.List<AccountEntry> filterFindByCompanyId(
		long companyId) {
	 ...
	 * @return the matching account entries
	 */
	public default java.util.List<AccountEntry> findByC_S(
		long companyId, int status) {
	 ...
	 * @return the matching account entries that the user has permission to view
	 */
	public default java.util.List<AccountEntry> filterFindByC_S(
		long companyId, int status) {
	 ...
	 * @return the matching account entries
	 */
	public default java.util.List<AccountEntry> findByU_T(
		long userId, String type) {
	 ...
	 * @return the matching account entries that the user has permission to view
	 */
	public default java.util.List<AccountEntry> filterFindByU_T(
		long userId, String type) {
...
// LIFERAY-SERVICE-BUILDER-HASH:-1977758274