 ...
 * @author Bryan Engler
 */
public class BaseSearchResponseAssembler {

	public static final BaseSearchResponseAssembler INSTANCE =
		new BaseSearchResponseAssembler();
	...
	private BaseSearchResponseAssembler() {
	}
