...
public interface CTCollectionPersistence extends BasePersistence<CTCollection> {
	 ...
	 * @return the matching ct collection, or <code>null</code> if a matching ct collection could not be found
	 */
	public default CTCollection fetchByERC_C(
		String externalReferenceCode, long companyId) {
	 ...
	 */
	public default java.util.List<CTCollection> findByUuid(String uuid) {
		return findByUuid(
	 ...
	 */
	public default java.util.List<CTCollection> findByUuid(
		String uuid, int start, int end) {
	 ...
	 */
	public default java.util.List<CTCollection> filterFindByUuid(String uuid) {
	 ...
	 */
	public default java.util.List<CTCollection> filterFindByUuid(
		String uuid, int start, int end) {
	 ...
	 * @return the matching ct collections
	 */
	public default java.util.List<CTCollection> findByUuid_C(
		String uuid, long companyId) {
	 ...
	 * @return the matching ct collections that the user has permission to view
	 */
	public default java.util.List<CTCollection> filterFindByUuid_C(
		String uuid, long companyId) {
	 ...
	 * @return the matching ct collections
	 */
	public default java.util.List<CTCollection> findByCompanyId(
		long companyId) {
	 ...
	 * @return the matching ct collections that the user has permission to view
	 */
	public default java.util.List<CTCollection> filterFindByCompanyId(
		long companyId) {
	 ...
	 * @return the matching ct collections
	 */
	public default java.util.List<CTCollection> findByC_U(
		long companyId, long userId) {
	 ...
	 * @return the matching ct collections that the user has permission to view
	 */
	public default java.util.List<CTCollection> filterFindByC_U(
		long companyId, long userId) {
	 ...
	 * @return the matching ct collections
	 */
	public default java.util.List<CTCollection> findByC_SVI(
		long companyId, long schemaVersionId) {
	...
	public default java.util.List<CTCollection> findByC_SVI(
		...
		return findByC_SVI(companyId, schemaVersionId, start, end, null, true);
	}
	 ...
	 * @return the matching ct collections that the user has permission to view
	 */
	public default java.util.List<CTCollection> filterFindByC_SVI(
		long companyId, long schemaVersionId) {
	 ...
	 * @return the matching ct collections
	 */
	public default java.util.List<CTCollection> findByC_S(
		long companyId, int status) {
	...
	public default java.util.List<CTCollection> findByC_S(
		...
		return findByC_S(companyId, statuses, start, end, null, true);
	}
	 ...
	 * @return the matching ct collections that the user has permission to view
	 */
	public default java.util.List<CTCollection> filterFindByC_S(
		long companyId, int status) {
...
// LIFERAY-SERVICE-BUILDER-HASH:1618916131