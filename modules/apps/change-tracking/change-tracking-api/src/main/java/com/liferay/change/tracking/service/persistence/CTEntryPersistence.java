...
public interface CTEntryPersistence extends BasePersistence<CTEntry> {
	 ...
	 * @return the matching ct entry, or <code>null</code> if a matching ct entry could not be found
	 */
	public default CTEntry fetchByC_MCNI_MCPK(
		long ctCollectionId, long modelClassNameId, long modelClassPK) {
	 ...
	 * @return the matching ct entry, or <code>null</code> if a matching ct entry could not be found
	 */
	public default CTEntry fetchByERC_C(
	 ...
	 * @return the matching ct entries
	 */
	public default java.util.List<CTEntry> findByUuid(String uuid) {
		return findByUuid(
	 ...
	 * @return the range of matching ct entries
	 */
	public default java.util.List<CTEntry> findByUuid(
		String uuid, int start, int end) {
	 ...
	 * @return the matching ct entries
	 */
	public default java.util.List<CTEntry> findByUuid_C(
		String uuid, long companyId) {
	 ...
	 * @return the matching ct entries
	 */
	public default java.util.List<CTEntry> findByUserId(long userId) {
		return findByUserId(
	 ...
	 * @return the range of matching ct entries
	 */
	public default java.util.List<CTEntry> findByUserId(
		long userId, int start, int end) {
	 ...
	 * @return the matching ct entries
	 */
	public default java.util.List<CTEntry> findByCtCollectionId(
		long ctCollectionId) {

		return findByCtCollectionId(
			ctCollectionId, com.liferay.portal.kernel.dao.orm.QueryUtil.ALL_POS,
			com.liferay.portal.kernel.dao.orm.QueryUtil.ALL_POS, null, true);
	}
	...
	public default java.util.List<CTEntry> findByCtCollectionId(
		...
		return findByCtCollectionId(ctCollectionId, start, end, null, true);
	}
	 ...
	 * @return the matching ct entries
	 */
	public default java.util.List<CTEntry> findByC_MCNI(
		long ctCollectionId, long modelClassNameId) {
	...
	public default java.util.List<CTEntry> findByC_MCNI(
		...
		return findByC_MCNI(
			ctCollectionId, modelClassNameId, start, end, null, true);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:-1709652720