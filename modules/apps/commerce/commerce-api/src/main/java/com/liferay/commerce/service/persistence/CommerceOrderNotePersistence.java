...
public interface CommerceOrderNotePersistence
	 ...
	 * @return the matching commerce order note, or <code>null</code> if a matching commerce order note could not be found
	 */
	public default CommerceOrderNote fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching commerce order note, or <code>null</code> if a matching commerce order note could not be found
	 */
	public default CommerceOrderNote fetchByERC_C(
		String externalReferenceCode, long companyId) {
	 ...
	 */
	public default java.util.List<CommerceOrderNote> findByUuid(String uuid) {
		return findByUuid(
	 ...
	 */
	public default java.util.List<CommerceOrderNote> findByUuid(
		String uuid, int start, int end) {
	 ...
	 * @return the matching commerce order notes
	 */
	public default java.util.List<CommerceOrderNote> findByUuid_C(
		String uuid, long companyId) {
	 ...
	 * @return the matching commerce order notes
	 */
	public default java.util.List<CommerceOrderNote> findByCommerceOrderId(
		long commerceOrderId) {
	 ...
	 * @return the matching commerce order notes
	 */
	public default java.util.List<CommerceOrderNote> findByC_R(
		long commerceOrderId, boolean restricted) {
...
// LIFERAY-SERVICE-BUILDER-HASH:1409595903