...
public interface CommerceCurrencyPersistence
	 ...
	 * @return the matching commerce currency, or <code>null</code> if a matching commerce currency could not be found
	 */
	public default CommerceCurrency fetchByC_C(long companyId, String code) {
	 ...
	 * @return the matching commerce currency, or <code>null</code> if a matching commerce currency could not be found
	 */
	public default CommerceCurrency fetchByERC_C(
		String externalReferenceCode, long companyId) {
	 ...
	 */
	public default java.util.List<CommerceCurrency> findByUuid(String uuid) {
		return findByUuid(
	 ...
	 */
	public default java.util.List<CommerceCurrency> findByUuid(
		String uuid, int start, int end) {
	 ...
	 * @return the matching commerce currencies
	 */
	public default java.util.List<CommerceCurrency> findByUuid_C(
		String uuid, long companyId) {
	 ...
	 * @return the matching commerce currencies
	 */
	public default java.util.List<CommerceCurrency> findByCompanyId(
		long companyId) {
	 ...
	 * @return the matching commerce currencies
	 */
	public default java.util.List<CommerceCurrency> findByC_P(
		long companyId, boolean primary) {
	...
	public default java.util.List<CommerceCurrency> findByC_P(
		...
		return findByC_P(companyId, primary, start, end, null, true);
	}
	 ...
	 * @return the matching commerce currencies
	 */
	public default java.util.List<CommerceCurrency> findByC_A(
		long companyId, boolean active) {
	 ...
	 * @return the matching commerce currencies
	 */
	public default java.util.List<CommerceCurrency> findByC_P_A(
		long companyId, boolean primary, boolean active) {
	...
	public default java.util.List<CommerceCurrency> findByC_P_A(
		...
		return findByC_P_A(companyId, primary, active, start, end, null, true);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:-1520418752