...
public interface CommercePriceListOrderTypeRelPersistence
	 ...
	 * @return the matching commerce price list order type rel, or <code>null</code> if a matching commerce price list order type rel could not be found
	 */
	public default CommercePriceListOrderTypeRel fetchByCPI_COTI(
		long commercePriceListId, long commerceOrderTypeId) {
	 ...
	 */
	public default java.util.List<CommercePriceListOrderTypeRel> findByUuid(
		String uuid) {
	 ...
	 * @return the matching commerce price list order type rels
	 */
	public default java.util.List<CommercePriceListOrderTypeRel> findByUuid_C(
		String uuid, long companyId) {
	 ...
	 * @return the matching commerce price list order type rels
	 */
	public default java.util.List<CommercePriceListOrderTypeRel>
...
// LIFERAY-SERVICE-BUILDER-HASH:-1592002700