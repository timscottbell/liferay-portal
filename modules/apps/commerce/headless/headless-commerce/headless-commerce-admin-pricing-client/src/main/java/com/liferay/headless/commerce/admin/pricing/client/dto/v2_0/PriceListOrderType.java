 ...
 */
@Generated("")
public class PriceListOrderType implements Cloneable, Serializable {

	public static PriceListOrderType toDTO(String json) {
		return PriceListOrderTypeSerDes.toDTO(json);
	}
	...
	@Override
	public PriceListOrderType clone() throws CloneNotSupportedException {
		return (PriceListOrderType)super.clone();
	}
	...
	public String toString() {
		return PriceListOrderTypeSerDes.toJSON(this);
	}

}
// LIFERAY-REST-BUILDER-HASH:-1296674979