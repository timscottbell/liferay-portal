 ...
 */
@Generated("")
public class PlacedOrderAddress implements Cloneable, Serializable {

	public static PlacedOrderAddress toDTO(String json) {
		return PlacedOrderAddressSerDes.toDTO(json);
	}
	...
	@Override
	public PlacedOrderAddress clone() throws CloneNotSupportedException {
		return (PlacedOrderAddress)super.clone();
	}
	...
	public String toString() {
		return PlacedOrderAddressSerDes.toJSON(this);
	}
