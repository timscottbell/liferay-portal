...
public interface DSRecipientViewDefinitionResource {
	...
	public void postSiteDSRecipientViewDefinitionBatch(
			Long siteId, String dsEnvelopeId, String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse
			postSiteDSRecipientViewDefinitionBatchHttpResponse(
				Long siteId, String dsEnvelopeId, String callbackURL,
				Object object)
		throws Exception;
	...
	public static class DSRecipientViewDefinitionResourceImpl
		...
		public void postSiteDSRecipientViewDefinitionBatch(
			...
			HttpInvoker.HttpResponse httpResponse =
				postSiteDSRecipientViewDefinitionBatchHttpResponse(
					siteId, dsEnvelopeId, callbackURL, object);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/digital-signature-rest/v1.0/sites/{siteId}/ds-recipient-view-definition/{dsEnvelopeId}/batch");
...
// LIFERAY-REST-BUILDER-HASH:1653005597