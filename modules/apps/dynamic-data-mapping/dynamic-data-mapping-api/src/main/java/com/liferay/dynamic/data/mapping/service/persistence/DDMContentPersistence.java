...
public interface DDMContentPersistence
	 ...
	 * @return the matching ddm content, or <code>null</code> if a matching ddm content could not be found
	 */
	public default DDMContent fetchByUUID_G(String uuid, long groupId) {
	 ...
	 */
	public default java.util.List<DDMContent> findByUuid(String uuid) {
		return findByUuid(
	 ...
	 */
	public default java.util.List<DDMContent> findByUuid(
		String uuid, int start, int end) {
	 ...
	 * @return the matching ddm contents
	 */
	public default java.util.List<DDMContent> findByUuid_C(
		String uuid, long companyId) {
	 ...
	 * @return the matching ddm contents
	 */
	public default java.util.List<DDMContent> findByGroupId(long groupId) {
	 ...
	 * @return the range of matching ddm contents
	 */
	public default java.util.List<DDMContent> findByGroupId(
		long groupId, int start, int end) {
	 ...
	 * @return the matching ddm contents
	 */
	public default java.util.List<DDMContent> findByCompanyId(long companyId) {
	 ...
	 * @return the range of matching ddm contents
	 */
	public default java.util.List<DDMContent> findByCompanyId(
		long companyId, int start, int end) {
...
// LIFERAY-SERVICE-BUILDER-HASH:1887774766