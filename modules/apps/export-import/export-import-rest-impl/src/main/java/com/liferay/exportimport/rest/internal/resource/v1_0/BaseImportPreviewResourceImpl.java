...
public abstract class BaseImportPreviewResourceImpl
	implements EntityModelResource, ImportPreviewResource,
			   VulcanBatchEngineTaskItemDelegate<ImportPreview> {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/export-import/v1.0/asset-libraries/{assetLibraryExternalReferenceCode}/import-preview'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @io.swagger.v3.oas.annotations.media.Content(mediaType = "multipart/form-data", schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = PostAssetLibraryImportPreviewRequestBody.class)))
	)
	...
	@jakarta.ws.rs.Path(
		"/asset-libraries/{assetLibraryExternalReferenceCode}/import-preview"
	)
	@jakarta.ws.rs.POST
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/export-import/v1.0/asset-libraries/{assetLibraryExternalReferenceCode}/import-preview/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@jakarta.ws.rs.Path(
		"/asset-libraries/{assetLibraryExternalReferenceCode}/import-preview/batch"
	)
	@jakarta.ws.rs.POST
	...
	public Response postAssetLibraryImportPreviewBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				ImportPreview.class.getName(), callbackURL, null, object)
		).build();
	}
	...
	@jakarta.ws.rs.Consumes("multipart/form-data")
	@jakarta.ws.rs.Path("/import-preview")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/export-import/v1.0/import-preview/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path("/import-preview/batch")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
	 ...
	 */
	@io.swagger.v3.oas.annotations.Operation(
		requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @io.swagger.v3.oas.annotations.media.Content(mediaType = "multipart/form-data", schema = @io.swagger.v3.oas.annotations.media.Schema(implementation = PostSiteImportPreviewRequestBody.class)))
	)
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@jakarta.ws.rs.Consumes("multipart/form-data")
	@jakarta.ws.rs.Path("/sites/{siteExternalReferenceCode}/import-preview")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/export-import/v1.0/sites/{siteExternalReferenceCode}/import-preview/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path(
		"/sites/{siteExternalReferenceCode}/import-preview/batch"
	)
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
	...
	public void create(
			Collection<ImportPreview> importPreviews,
			Map<String, Serializable> parameters)
		throws Exception {

		UnsafeFunction<ImportPreview, ImportPreview, Exception>
			importPreviewUnsafeFunction = null;
		...
		if (importPreviewUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for ImportPreview");
		}

		if (contextBatchUnsafeBiConsumer != null) {
			contextBatchUnsafeBiConsumer.accept(
				importPreviews, importPreviewUnsafeFunction);
		}
		else if (contextBatchUnsafeConsumer != null) {
			contextBatchUnsafeConsumer.accept(
				importPreviews, importPreviewUnsafeFunction::apply);
		}
		else {
			for (ImportPreview importPreview : importPreviews) {
				importPreviewUnsafeFunction.apply(importPreview);
			}
		}
	}
	...
	@Override
	public Page<ImportPreview> read(
	...
	public void setContextBatchUnsafeBiConsumer(
		UnsafeBiConsumer
			<Collection<ImportPreview>,
			 UnsafeFunction<ImportPreview, ImportPreview, Exception>, Exception>
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<ImportPreview>,
			 UnsafeConsumer<ImportPreview, Exception>, Exception>
	...
	protected UnsafeBiConsumer
		<Collection<ImportPreview>,
		 UnsafeFunction<ImportPreview, ImportPreview, Exception>, Exception>
			contextBatchUnsafeBiConsumer;
	protected UnsafeBiConsumer
		<Collection<ImportPreview>, UnsafeConsumer<ImportPreview, Exception>,
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseImportPreviewResourceImpl.class);

	private class PostAssetLibraryImportPreviewRequestBody {
