...
public class Project implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The project's external reference code."
	)
	...
	@GraphQLField(description = "The project's external reference code.")
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The project's site ID."
	)
	public Long getId() {
		if (_idSupplier != null) {
			id = _idSupplier.get();
	...
	@GraphQLField(description = "The project's site ID.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected Long id;
	...
	@GraphQLField(description = "The project's name.")
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The localized project's name."
	)
	@Valid
	...
	@GraphQLField(description = "The localized project's name.")
	@JsonProperty(access = JsonProperty.Access.READ_ONLY)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The project's scope key."
	)
	...
	@GraphQLField(description = "The project's scope key.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.taxonomy.dto.v1_0.Project",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:1248759680