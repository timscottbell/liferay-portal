...
import com.liferay.headless.admin.user.client.serdes.v1_0.AccountContactInformationSerDes;
 ...
 */
@Generated("")
public class AccountContactInformation implements Cloneable, Serializable {

	public static AccountContactInformation toDTO(String json) {
		return AccountContactInformationSerDes.toDTO(json);
	}
	...
	@Override
	public AccountContactInformation clone() throws CloneNotSupportedException {
		return (AccountContactInformation)super.clone();
	}
	...
	public String toString() {
		return AccountContactInformationSerDes.toJSON(this);
	}
