...
import com.liferay.headless.admin.user.client.dto.v1_0.Link;
...
public class LinkSerDes {
	...
	public static String toJSON(Link link) {
		...
		if (link.getHref() != null) {
			...
			sb.append(_escape(link.getHref()));
		...
		if (link.getLabel() != null) {
			...
			sb.append(_escape(link.getLabel()));
	...
	public static Map<String, String> toMap(Link link) {
		...
		if (link.getHref() == null) {
			...
			map.put("href", String.valueOf(link.getHref()));
		}
		...
		if (link.getLabel() == null) {
			...
			map.put("label", String.valueOf(link.getLabel()));
		}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "href")) {
				if (jsonParserFieldValue != null) {
					link.setHref((String)jsonParserFieldValue);
				}
			}
			else if (Objects.equals(jsonParserFieldName, "label")) {
				if (jsonParserFieldValue != null) {
					link.setLabel((String)jsonParserFieldValue);
				}
			}
		}
...
// LIFERAY-REST-BUILDER-HASH:-723565631