...
public interface WorkflowInstanceResource {
	...
	public HttpInvoker.HttpResponse patchWorkflowInstanceHttpResponse(
			Long workflowInstanceId, WorkflowInstance workflowInstance)
		throws Exception;
	...
	public static class WorkflowInstanceResourceImpl
		...
		public WorkflowInstance patchWorkflowInstance(
			...
			HttpInvoker.HttpResponse httpResponse =
				patchWorkflowInstanceHttpResponse(
		...
		public HttpInvoker.HttpResponse patchWorkflowInstanceHttpResponse(
			...
			httpInvoker.body(workflowInstance.toString(), "application/json");
...
// LIFERAY-REST-BUILDER-HASH:-1749212229