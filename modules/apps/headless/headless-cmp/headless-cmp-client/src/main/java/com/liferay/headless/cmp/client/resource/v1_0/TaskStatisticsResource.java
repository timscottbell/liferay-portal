...
public interface TaskStatisticsResource {
	...
	public static class Builder {
		...
		public TaskStatisticsResource build() {
			return new TaskStatisticsResourceImpl(this);
		}
	...
	public static class TaskStatisticsResourceImpl
		...
		public TaskStatistics getProjectTaskStatistics(
			...
			try {
				return TaskStatisticsSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private TaskStatisticsResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			TaskStatisticsResource.class.getName());
