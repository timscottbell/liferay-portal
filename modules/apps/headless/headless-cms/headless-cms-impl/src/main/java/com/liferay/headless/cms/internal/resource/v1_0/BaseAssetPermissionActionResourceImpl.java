...
public abstract class BaseAssetPermissionActionResourceImpl
	implements AssetPermissionActionResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-cms/v1.0/asset-permission' -d $'{"className": ___, "classPK": ___, "type": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Perform an action on the asset's permissions"
	)
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
				name = "AssetPermissionAction"
			)
		}
	)
	@jakarta.ws.rs.Consumes({"application/json", "application/xml"})
	@jakarta.ws.rs.Path("/asset-permission")
	@jakarta.ws.rs.POST
