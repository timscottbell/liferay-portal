 ...
 */
@Generated("")
public class DocumentDataDefinitionType implements Cloneable, Serializable {

	public static DocumentDataDefinitionType toDTO(String json) {
		return DocumentDataDefinitionTypeSerDes.toDTO(json);
	}
	...
	public void setDocumentMetadataSetIds(
		...
		try {
			documentMetadataSetIds = documentMetadataSetIdsUnsafeSupplier.get();
		}
		catch (Exception e) {
			throw new RuntimeException(e);
		}
	...
	@Override
	public DocumentDataDefinitionType clone()
		throws CloneNotSupportedException {

		return (DocumentDataDefinitionType)super.clone();
	}
	...
	public String toString() {
		return DocumentDataDefinitionTypeSerDes.toJSON(this);
	}
