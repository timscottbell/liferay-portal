 ...
 */
@Generated("")
public class DocumentShortcut implements Cloneable, Serializable {
	...
	public void setTargetDocumentId(
		...
		try {
			targetDocumentId = targetDocumentIdUnsafeSupplier.get();
		}
		catch (Exception e) {
			throw new RuntimeException(e);
		}
	...
	@Override
	public DocumentShortcut clone() throws CloneNotSupportedException {
		return (DocumentShortcut)super.clone();
	}
	...
	public String toString() {
		return DocumentShortcutSerDes.toJSON(this);
	}
