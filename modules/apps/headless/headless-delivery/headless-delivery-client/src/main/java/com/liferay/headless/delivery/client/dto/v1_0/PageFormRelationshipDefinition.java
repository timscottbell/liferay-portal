...
import com.liferay.headless.delivery.client.serdes.v1_0.PageFormRelationshipDefinitionSerDes;
 ...
 */
@Generated("")
public class PageFormRelationshipDefinition implements Cloneable, Serializable {

	public static PageFormRelationshipDefinition toDTO(String json) {
		return PageFormRelationshipDefinitionSerDes.toDTO(json);
	}
	...
	public PageFormRelationshipDefinition clone()
		...
		return (PageFormRelationshipDefinition)super.clone();
	}
	...
	public String toString() {
		return PageFormRelationshipDefinitionSerDes.toJSON(this);
	}

}
// LIFERAY-REST-BUILDER-HASH:-1703134915