...
public interface LayoutPageTemplateStructurePersistence
	 ...
	 * @return the matching layout page template structure, or <code>null</code> if a matching layout page template structure could not be found
	 */
	public default LayoutPageTemplateStructure fetchByUUID_G(
	 ...
	 * @return the matching layout page template structure, or <code>null</code> if a matching layout page template structure could not be found
	 */
	public default LayoutPageTemplateStructure fetchByG_P(
	 ...
	 */
	public default java.util.List<LayoutPageTemplateStructure> findByUuid(
		String uuid) {
	 ...
	 * @return the matching layout page template structures
	 */
	public default java.util.List<LayoutPageTemplateStructure> findByUuid_C(
		String uuid, long companyId) {
	 ...
	 * @return the matching layout page template structures
	 */
	public default java.util.List<LayoutPageTemplateStructure> findByGroupId(
		long groupId) {
...
// LIFERAY-SERVICE-BUILDER-HASH:1233956490