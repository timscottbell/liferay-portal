...
public interface AppPersistence extends BasePersistence<App> {
	 ...
	 * @return the matching app, or <code>null</code> if a matching app could not be found
	 */
	public default App fetchByRemoteAppId(long remoteAppId) {
	 ...
	 */
	public default java.util.List<App> findByUuid(String uuid) {
		return findByUuid(
	 ...
	 */
	public default java.util.List<App> findByUuid(
		String uuid, int start, int end) {
	 ...
	 * @return the matching apps
	 */
	public default java.util.List<App> findByUuid_C(
		String uuid, long companyId) {
	 ...
	 * @return the matching apps
	 */
	public default java.util.List<App> findByCompanyId(long companyId) {
	 ...
	 * @return the range of matching apps
	 */
	public default java.util.List<App> findByCompanyId(
		long companyId, int start, int end) {
	 ...
	 * @return the matching apps
	 */
	public default java.util.List<App> findByCategory(String category) {
		return findByCategory(
			category, com.liferay.portal.kernel.dao.orm.QueryUtil.ALL_POS,
			com.liferay.portal.kernel.dao.orm.QueryUtil.ALL_POS, null, true);
	}
	 ...
	 * @return the range of matching apps
	 */
	public default java.util.List<App> findByCategory(
		String category, int start, int end) {

		return findByCategory(category, start, end, null, true);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:821702080