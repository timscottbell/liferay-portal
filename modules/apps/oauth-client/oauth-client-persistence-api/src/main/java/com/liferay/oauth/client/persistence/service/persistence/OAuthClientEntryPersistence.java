...
public interface OAuthClientEntryPersistence
	 ...
	 * @return the matching o auth client entry, or <code>null</code> if a matching o auth client entry could not be found
	 */
	public default OAuthClientEntry fetchByC_A_C(
		long companyId, String authServerWellKnownURI, String clientId) {
	 ...
	 * @return the matching o auth client entry, or <code>null</code> if a matching o auth client entry could not be found
	 */
	public default OAuthClientEntry fetchByERC_C(
		String externalReferenceCode, long companyId) {
	 ...
	 */
	public default java.util.List<OAuthClientEntry> findByUuid(String uuid) {
		return findByUuid(
	 ...
	 */
	public default java.util.List<OAuthClientEntry> findByUuid(
		String uuid, int start, int end) {
	 ...
	 */
	public default java.util.List<OAuthClientEntry> filterFindByUuid(
		String uuid) {
	 ...
	 * @return the matching o auth client entries
	 */
	public default java.util.List<OAuthClientEntry> findByUuid_C(
		String uuid, long companyId) {
	 ...
	 * @return the matching o auth client entries that the user has permission to view
	 */
	public default java.util.List<OAuthClientEntry> filterFindByUuid_C(
		String uuid, long companyId) {
	 ...
	 * @return the matching o auth client entries
	 */
	public default java.util.List<OAuthClientEntry> findByCompanyId(
		long companyId) {
	 ...
	 * @return the matching o auth client entries that the user has permission to view
	 */
	public default java.util.List<OAuthClientEntry> filterFindByCompanyId(
		long companyId) {
	 ...
	 * @return the matching o auth client entries
	 */
	public default java.util.List<OAuthClientEntry> findByUserId(long userId) {
		return findByUserId(
	 ...
	 * @return the range of matching o auth client entries
	 */
	public default java.util.List<OAuthClientEntry> findByUserId(
		long userId, int start, int end) {
	 ...
	 * @return the matching o auth client entries that the user has permission to view
	 */
	public default java.util.List<OAuthClientEntry> filterFindByUserId(
		long userId) {
	 ...
	 * @return the matching o auth client entries
	 */
	public default java.util.List<OAuthClientEntry> findByC_A(
		long companyId, String authServerWellKnownURI) {
	...
	public default java.util.List<OAuthClientEntry> findByC_A(
		...
		return findByC_A(
			companyId, authServerWellKnownURI, start, end, null, true);
	}
	 ...
	 * @return the matching o auth client entries that the user has permission to view
	 */
	public default java.util.List<OAuthClientEntry> filterFindByC_A(
		long companyId, String authServerWellKnownURI) {
...
// LIFERAY-SERVICE-BUILDER-HASH:-1676688875