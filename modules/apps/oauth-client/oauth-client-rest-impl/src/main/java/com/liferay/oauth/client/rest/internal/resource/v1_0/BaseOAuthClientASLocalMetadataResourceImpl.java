...
public abstract class BaseOAuthClientASLocalMetadataResourceImpl
	implements EntityModelResource, OAuthClientASLocalMetadataResource,
			   VulcanBatchEngineTaskItemDelegate<OAuthClientASLocalMetadata> {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/oauth-client/v1.0/oauth-client-as-local-metadatas'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/oauth-client-as-local-metadatas")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/oauth-client/v1.0/oauth-client-as-local-metadatas' -d $'{"dateCreated": ___, "dateModified": ___, "externalReferenceCode": ___, "issuer": ___, "localWellKnownEnabled": ___, "localWellKnownURI": ___, "metadataJSON": ___, "oAuthASLocalWellKnownURI": ___, "oAuthASMetadataJSON": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/oauth-client/v1.0/oauth-client-as-local-metadatas/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@jakarta.ws.rs.Path("/oauth-client-as-local-metadatas/batch")
	@jakarta.ws.rs.POST
	...
	public Response postOAuthClientASLocalMetadataBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				OAuthClientASLocalMetadata.class.getName(), callbackURL, null,
				object)
		).build();
	}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/oauth-client/v1.0/oauth-client-as-local-metadatas/export-batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path("/oauth-client-as-local-metadatas/export-batch")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
	public Response postOAuthClientASLocalMetadatasPageExportBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				OAuthClientASLocalMetadata.class.getName(), callbackURL,
	...
	public void create(
			Collection<OAuthClientASLocalMetadata> oAuthClientASLocalMetadatas,
	...
	@Override
	public Page<OAuthClientASLocalMetadata> read(
		...
		return getOAuthClientASLocalMetadatasPage();
	}
	...
	public void setContextBatchUnsafeBiConsumer(
		UnsafeBiConsumer
			<Collection<OAuthClientASLocalMetadata>,
			 UnsafeFunction
				 <OAuthClientASLocalMetadata, OAuthClientASLocalMetadata,
				  Exception>,
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<Collection<OAuthClientASLocalMetadata>,
			 UnsafeConsumer<OAuthClientASLocalMetadata, Exception>, Exception>
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseOAuthClientASLocalMetadataResourceImpl.class);

}
// LIFERAY-REST-BUILDER-HASH:-400297945