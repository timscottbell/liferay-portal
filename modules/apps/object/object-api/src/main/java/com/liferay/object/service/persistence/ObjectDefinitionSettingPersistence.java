...
public interface ObjectDefinitionSettingPersistence
	 ...
	 * @return the matching object definition setting, or <code>null</code> if a matching object definition setting could not be found
	 */
	public default ObjectDefinitionSetting fetchByODI_N(
		long objectDefinitionId, String name) {
	 ...
	 */
	public default java.util.List<ObjectDefinitionSetting> findByUuid(
		String uuid) {
	 ...
	 * @return the matching object definition settings
	 */
	public default java.util.List<ObjectDefinitionSetting> findByUuid_C(
		String uuid, long companyId) {
	 ...
	 * @return the matching object definition settings
	 */
	public default java.util.List<ObjectDefinitionSetting>
	 ...
	 * @return the matching object definition settings
	 */
	public default java.util.List<ObjectDefinitionSetting> findByC_N(
		long companyId, String name) {
	 ...
	 * @return the matching object definition settings
	 */
	public default java.util.List<ObjectDefinitionSetting> findByC_N_V(
		long companyId, String name, String value) {
	...
	public default java.util.List<ObjectDefinitionSetting> findByC_N_V(
		...
		return findByC_N_V(companyId, name, value, start, end, null, true);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:-1388604414