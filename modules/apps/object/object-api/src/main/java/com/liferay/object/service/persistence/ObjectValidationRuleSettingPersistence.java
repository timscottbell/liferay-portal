...
public interface ObjectValidationRuleSettingPersistence
	 ...
	 * @return the matching object validation rule setting, or <code>null</code> if a matching object validation rule setting could not be found
	 */
	public default ObjectValidationRuleSetting fetchByN_V(
	 ...
	 * @return the matching object validation rule setting, or <code>null</code> if a matching object validation rule setting could not be found
	 */
	public default ObjectValidationRuleSetting fetchByOVRI_N_V(
		long objectValidationRuleId, String name, String value) {
	 ...
	 */
	public default java.util.List<ObjectValidationRuleSetting> findByUuid(
		String uuid) {
	 ...
	 * @return the matching object validation rule settings
	 */
	public default java.util.List<ObjectValidationRuleSetting> findByUuid_C(
		String uuid, long companyId) {
	 ...
	 * @return the matching object validation rule settings
	 */
	public default java.util.List<ObjectValidationRuleSetting>
	...
	public default java.util.List<ObjectValidationRuleSetting>
		...
		return findByObjectValidationRuleId(
			objectValidationRuleId, start, end, null, true);
	}
	 ...
	 * @return the matching object validation rule settings
	 */
	public default java.util.List<ObjectValidationRuleSetting> findByOVRI_N(
		long objectValidationRuleId, String name) {

		return findByOVRI_N(
			objectValidationRuleId, name,
			com.liferay.portal.kernel.dao.orm.QueryUtil.ALL_POS,
			com.liferay.portal.kernel.dao.orm.QueryUtil.ALL_POS, null, true);
	}
	...
	public default java.util.List<ObjectValidationRuleSetting> findByOVRI_N(
		...
		return findByOVRI_N(
			objectValidationRuleId, name, start, end, null, true);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:2001843413