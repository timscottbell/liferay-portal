...
public interface KaleoTaskAssignmentPersistence
	 ...
	 */
	public default java.util.List<KaleoTaskAssignment> findByCompanyId(
		long companyId) {
	 ...
	 * @return the matching kaleo task assignments
	 */
	public default java.util.List<KaleoTaskAssignment>
	 ...
	 * @return the matching kaleo task assignments
	 */
	public default java.util.List<KaleoTaskAssignment> findByKCN_KCPK(
		String kaleoClassName, long kaleoClassPK) {
	 ...
	 * @return the matching kaleo task assignments
	 */
	public default java.util.List<KaleoTaskAssignment> findByKCN_KCPK_ACN(
		String kaleoClassName, long kaleoClassPK, String assigneeClassName) {
...
// LIFERAY-SERVICE-BUILDER-HASH:-34322483