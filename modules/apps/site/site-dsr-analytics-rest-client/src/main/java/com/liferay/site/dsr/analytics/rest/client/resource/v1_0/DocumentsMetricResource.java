 ...
 */
@Generated("")
public interface DocumentsMetricResource {
	...
	public HttpInvoker.HttpResponse getDocumentsMetricHttpResponse(
			String[] groupIds, String keywords, String rangeEnd,
			Integer rangeKey, String rangeStart, Integer size,
			String sortColumn, String sortType, Integer start)
		throws Exception;
	...
	public static class Builder {
		...
		public DocumentsMetricResource build() {
			return new DocumentsMetricResourceImpl(this);
		}
	...
	public static class DocumentsMetricResourceImpl
		implements DocumentsMetricResource {
		...
		public DocumentsMetric getDocumentsMetric(
			...
			HttpInvoker.HttpResponse httpResponse =
				getDocumentsMetricHttpResponse(
		...
		public HttpInvoker.HttpResponse getDocumentsMetricHttpResponse(
			...
			if (sortColumn != null) {
				httpInvoker.parameter("sortColumn", String.valueOf(sortColumn));
			}

			if (sortType != null) {
				httpInvoker.parameter("sortType", String.valueOf(sortType));
			}
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/site-dsr-analytics-rest/v1.0/documents-metric");
		...
		private DocumentsMetricResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			DocumentsMetricResource.class.getName());
