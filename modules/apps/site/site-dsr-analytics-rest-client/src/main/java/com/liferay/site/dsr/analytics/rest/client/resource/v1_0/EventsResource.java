...
public interface EventsResource {
	...
	public static class Builder {
		...
		public EventsResource build() {
			return new EventsResourceImpl(this);
		}
	...
	public static class EventsResourceImpl implements EventsResource {

		public Events getEvents(
				String[] groupIds, Boolean includeAnonymousUsers,
				String individualId, String keywords, Integer page,
				String rangeEnd, Integer rangeKey, String rangeStart,
				Integer size)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse = getEventsHttpResponse(
				groupIds, includeAnonymousUsers, individualId, keywords, page,
			...
			try {
				return EventsSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/site-dsr-analytics-rest/v1.0/events");
		...
		private EventsResourceImpl(Builder builder) {
			_builder = builder;
		}
...
// LIFERAY-REST-BUILDER-HASH:979090884