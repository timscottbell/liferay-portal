 ...
 */
@Generated("")
public interface MostActiveVisitorsResource {
	...
	public MostActiveVisitors getMostActiveVisitors(
			...
			String rangeStart, Integer size, Integer start)
		throws Exception;

	public HttpInvoker.HttpResponse getMostActiveVisitorsHttpResponse(
			String[] groupIds, String rangeEnd, Integer rangeKey,
			String rangeStart, Integer size, Integer start)
		throws Exception;
	...
	public static class Builder {
		...
		public MostActiveVisitorsResource build() {
			return new MostActiveVisitorsResourceImpl(this);
		}
	...
	public static class MostActiveVisitorsResourceImpl
		implements MostActiveVisitorsResource {
		...
		public MostActiveVisitors getMostActiveVisitors(
			...
			HttpInvoker.HttpResponse httpResponse =
				getMostActiveVisitorsHttpResponse(
					groupIds, rangeEnd, rangeKey, rangeStart, size, start);
			...
			try {
				return MostActiveVisitorsSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/site-dsr-analytics-rest/v1.0/most-active-visitors");
		...
		private MostActiveVisitorsResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			MostActiveVisitorsResource.class.getName());
...
// LIFERAY-REST-BUILDER-HASH:1968036042