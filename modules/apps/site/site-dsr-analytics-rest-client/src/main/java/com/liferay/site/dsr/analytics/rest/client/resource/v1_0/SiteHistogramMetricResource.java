 ...
 */
@Generated("")
public interface SiteHistogramMetricResource {
	...
	public HttpInvoker.HttpResponse getSessionsSiteHistogramMetricHttpResponse(
			String[] emailAddresses, String[] groupIds, String interval,
			String rangeEnd, Integer rangeKey, String rangeStart)
		throws Exception;
	...
	public static class Builder {
		...
		public SiteHistogramMetricResource build() {
			return new SiteHistogramMetricResourceImpl(this);
		}
	...
	public static class SiteHistogramMetricResourceImpl
		implements SiteHistogramMetricResource {
		...
		public SiteHistogramMetric getSessionsSiteHistogramMetric(
			...
			HttpInvoker.HttpResponse httpResponse =
				getSessionsSiteHistogramMetricHttpResponse(
					emailAddresses, groupIds, interval, rangeEnd, rangeKey,
					rangeStart);
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/site-dsr-analytics-rest/v1.0/sessions-site-histogram-metric");
		...
		private SiteHistogramMetricResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			SiteHistogramMetricResource.class.getName());
