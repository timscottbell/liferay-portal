 ...
 */
@Generated("")
public interface UserSessionsResource {
	...
	public HttpInvoker.HttpResponse getUserSessionsHttpResponse(
			String entityId, String entityType, String[] groupIds,
			String keywords, Integer page, String rangeEnd, Integer rangeKey,
			String rangeStart, Integer size)
		throws Exception;
	...
	public static class Builder {
		...
		public UserSessionsResource build() {
			return new UserSessionsResourceImpl(this);
		}
	...
	public static class UserSessionsResourceImpl
		implements UserSessionsResource {

		public UserSessions getUserSessions(
				String entityId, String entityType, String[] groupIds,
				String keywords, Integer page, String rangeEnd,
				Integer rangeKey, String rangeStart, Integer size)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse = getUserSessionsHttpResponse(
				entityId, entityType, groupIds, keywords, page, rangeEnd,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/site-dsr-analytics-rest/v1.0/user-sessions");
		...
		private UserSessionsResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			UserSessionsResource.class.getName());
