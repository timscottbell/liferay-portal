...
public abstract class BaseDocumentsMetricResourceImpl
	implements DocumentsMetricResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/site-dsr-analytics-rest/v1.0/documents-metric'  -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(name = "DocumentsMetric")
		}
	)
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/documents-metric")
	...
	public DocumentsMetric getDocumentsMetric(
			...
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.QueryParam("sortColumn")
			String sortColumn,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.QueryParam("sortType")
			String sortType,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
