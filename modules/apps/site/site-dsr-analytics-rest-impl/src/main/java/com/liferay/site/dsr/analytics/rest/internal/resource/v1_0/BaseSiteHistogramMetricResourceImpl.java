...
public abstract class BaseSiteHistogramMetricResourceImpl
	implements SiteHistogramMetricResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/site-dsr-analytics-rest/v1.0/sessions-site-histogram-metric'  -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
				name = "SiteHistogramMetric"
			)
		}
	)
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/sessions-site-histogram-metric")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public SiteHistogramMetric getSessionsSiteHistogramMetric(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.ws.rs.QueryParam("emailAddresses")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/site-dsr-analytics-rest/v1.0/visitors-site-histogram-metric'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/visitors-site-histogram-metric")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
