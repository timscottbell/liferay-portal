...
public abstract class BaseUserSessionsResourceImpl
	implements UserSessionsResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/site-dsr-analytics-rest/v1.0/user-sessions'  -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "UserSessions")}
	)
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/user-sessions")
