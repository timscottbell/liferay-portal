...
import com.liferay.site.dsr.analytics.rest.resource.v1_0.EventsResource;
...
@Component(
	...
	scope = ServiceScope.PROTOTYPE, service = EventsResource.class
)
public class EventsResourceImpl extends BaseEventsResourceImpl {
	...
	public Events getEvents(
		...
		return analyticsCloudClient.getEvents(
