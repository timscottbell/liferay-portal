...
public interface WikiPageResourcePersistence
	 ...
	 * @return the matching wiki page resource, or <code>null</code> if a matching wiki page resource could not be found
	 */
	public default WikiPageResource fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching wiki page resource, or <code>null</code> if a matching wiki page resource could not be found
	 */
	public default WikiPageResource fetchByN_T(long nodeId, String title) {
	 ...
	 */
	public default java.util.List<WikiPageResource> findByUuid(String uuid) {
		return findByUuid(
	 ...
	 */
	public default java.util.List<WikiPageResource> findByUuid(
		String uuid, int start, int end) {
	 ...
	 * @return the matching wiki page resources
	 */
	public default java.util.List<WikiPageResource> findByUuid_C(
		String uuid, long companyId) {
...
// LIFERAY-SERVICE-BUILDER-HASH:-813712584