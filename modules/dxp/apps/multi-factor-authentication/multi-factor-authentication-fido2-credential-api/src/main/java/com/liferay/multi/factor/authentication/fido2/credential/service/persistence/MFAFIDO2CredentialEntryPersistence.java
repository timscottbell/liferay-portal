...
public interface MFAFIDO2CredentialEntryPersistence
	 ...
	 * @return the matching mfafido2 credential entry, or <code>null</code> if a matching mfafido2 credential entry could not be found
	 */
	public default MFAFIDO2CredentialEntry fetchByU_C(
		long userId, long credentialKeyHash) {
	 ...
	 */
	public default java.util.List<MFAFIDO2CredentialEntry> findByUserId(
		long userId) {
	 ...
	 * @return the matching mfafido2 credential entries
	 */
	public default java.util.List<MFAFIDO2CredentialEntry>
	 ...
	 */
	public default java.util.List<MFAFIDO2CredentialEntry>
		findByCredentialKeyHash(long credentialKeyHash, int start, int end) {

		return findByCredentialKeyHash(
			credentialKeyHash, start, end, null, true);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:817616982