...
/**
 * Provides the local service utility for PatcherTicketHint. This utility wraps
 * <code>com.liferay.osb.patcher.service.impl.PatcherTicketHintLocalServiceImpl</code> and
 ...
 * @generated
 */
public class PatcherTicketHintLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.osb.patcher.service.impl.PatcherTicketHintLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static PatcherTicketHint addPatcherTicketHint(
		PatcherTicketHint patcherTicketHint) {

		return getService().addPatcherTicketHint(patcherTicketHint);
	}
	 ...
	 */
	public static PatcherTicketHint createPatcherTicketHint(
		long patcherTicketHintId) {

		return getService().createPatcherTicketHint(patcherTicketHintId);
	}
	 ...
	 */
	public static PatcherTicketHint deletePatcherTicketHint(
			long patcherTicketHintId)
		throws PortalException {

		return getService().deletePatcherTicketHint(patcherTicketHintId);
	}
	...
	public static PatcherTicketHint deletePatcherTicketHint(
		...
		return getService().deletePatcherTicketHint(patcherTicketHint);
	}
	...
	public static PatcherTicketHint fetchPatcherTicketHint(
		long patcherTicketHintId) {
	 ...
	 * @throws PortalException if a patcher ticket hint with the primary key could not be found
	 */
	public static PatcherTicketHint getPatcherTicketHint(
			long patcherTicketHintId)
		throws PortalException {

		return getService().getPatcherTicketHint(patcherTicketHintId);
	}
	 ...
	 */
	public static List<PatcherTicketHint> getPatcherTicketHints(
		int start, int end) {

		return getService().getPatcherTicketHints(start, end);
	}
	 ...
	 */
	public static int getPatcherTicketHintsCount() {
		return getService().getPatcherTicketHintsCount();
	}
	 ...
	 */
	public static PatcherTicketHint updatePatcherTicketHint(
		PatcherTicketHint patcherTicketHint) {

		return getService().updatePatcherTicketHint(patcherTicketHint);
	}

	public static PatcherTicketHintLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<PatcherTicketHintLocalService>
		_serviceSnapshot = new Snapshot<>(
			PatcherTicketHintLocalServiceUtil.class,
