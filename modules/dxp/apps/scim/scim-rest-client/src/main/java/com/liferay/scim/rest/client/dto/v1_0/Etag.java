...
import com.liferay.scim.rest.client.serdes.v1_0.EtagSerDes;
 ...
 */
@Generated("")
public class Etag implements Cloneable, Serializable {

	public static Etag toDTO(String json) {
		return EtagSerDes.toDTO(json);
	}
	...
	public String toString() {
		return EtagSerDes.toJSON(this);
	}

}
// LIFERAY-REST-BUILDER-HASH:-723661454