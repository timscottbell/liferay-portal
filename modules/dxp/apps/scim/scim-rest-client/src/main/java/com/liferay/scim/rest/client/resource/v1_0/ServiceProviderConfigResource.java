...
public interface ServiceProviderConfigResource {
	...
	public HttpInvoker.HttpResponse getV2ServiceProviderConfigHttpResponse()
		throws Exception;
	...
	public static class Builder {
		...
		public ServiceProviderConfigResource build() {
			return new ServiceProviderConfigResourceImpl(this);
		}
	...
	public static class ServiceProviderConfigResourceImpl
		...
		private ServiceProviderConfigResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ServiceProviderConfigResource.class.getName());
...
// LIFERAY-REST-BUILDER-HASH:-1037688806