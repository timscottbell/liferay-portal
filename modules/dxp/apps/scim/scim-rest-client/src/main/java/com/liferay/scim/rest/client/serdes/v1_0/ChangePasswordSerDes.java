...
import com.liferay.scim.rest.client.dto.v1_0.ChangePassword;
...
public class ChangePasswordSerDes {
	...
	public static String toJSON(ChangePassword changePassword) {
		...
		if (changePassword.getSupported() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(changePassword.getSupported());
		}
	...
	public static Map<String, String> toMap(ChangePassword changePassword) {
		...
		if (changePassword.getSupported() == null) {
			...
			map.put("supported", String.valueOf(changePassword.getSupported()));
		}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "supported")) {
				if (jsonParserFieldValue != null) {
					changePassword.setSupported((Boolean)jsonParserFieldValue);
				}
			}
		}
