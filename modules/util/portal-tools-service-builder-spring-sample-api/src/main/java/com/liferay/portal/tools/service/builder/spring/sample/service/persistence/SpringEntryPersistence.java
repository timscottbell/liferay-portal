...
public interface SpringEntryPersistence extends BasePersistence<SpringEntry> {
	 ...
	 */
	public default java.util.List<SpringEntry> findByUuid(String uuid) {
		return findByUuid(
	 ...
	 */
	public default java.util.List<SpringEntry> findByUuid(
		String uuid, int start, int end) {
	 ...
	 * @return the matching spring entries
	 */
	public default java.util.List<SpringEntry> findByUuid_C(
		String uuid, long companyId) {
	 ...
	 * @return the matching spring entries
	 */
	public default java.util.List<SpringEntry> findByCompanyId(long companyId) {
	 ...
	 * @return the range of matching spring entries
	 */
	public default java.util.List<SpringEntry> findByCompanyId(
		long companyId, int start, int end) {
...
// LIFERAY-SERVICE-BUILDER-HASH:889071505