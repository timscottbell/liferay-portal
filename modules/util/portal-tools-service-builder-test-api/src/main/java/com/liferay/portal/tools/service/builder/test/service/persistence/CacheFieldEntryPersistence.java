...
public interface CacheFieldEntryPersistence
	 ...
	 */
	public default java.util.List<CacheFieldEntry> findByGroupId(long groupId) {
	 ...
	 */
	public default java.util.List<CacheFieldEntry> findByGroupId(
		long groupId, int start, int end) {
...
// LIFERAY-SERVICE-BUILDER-HASH:-689384606