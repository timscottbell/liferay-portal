...
public interface IndexEntryPersistence
	 ...
	 * @return the matching index entry, or <code>null</code> if a matching index entry could not be found
	 */
	public default IndexEntry fetchByO_O_P_P(
		long ownerId, int ownerType, long plid, String portletId) {
	 ...
	 * @return the matching index entry, or <code>null</code> if a matching index entry could not be found
	 */
	public default IndexEntry fetchByERC_C(
		String externalReferenceCode, long companyId) {
	 ...
	 * @return the matching index entries
	 */
	public default java.util.List<IndexEntry> findByOwnerId(long ownerId) {
		return findByOwnerId(
			ownerId, com.liferay.portal.kernel.dao.orm.QueryUtil.ALL_POS,
	 ...
	 * @return the range of matching index entries
	 */
	public default java.util.List<IndexEntry> findByOwnerId(
		long ownerId, int start, int end) {

		return findByOwnerId(ownerId, start, end, null, true);
	}
	 ...
	 * @return the matching index entries
	 */
	public default java.util.List<IndexEntry> findByPlid(long plid) {
		return findByPlid(
	 ...
	 * @return the range of matching index entries
	 */
	public default java.util.List<IndexEntry> findByPlid(
		long plid, int start, int end) {
	 ...
	 * @return the matching index entries
	 */
	public default java.util.List<IndexEntry> findByPortletId(
		String portletId) {

		return findByPortletId(
			portletId, com.liferay.portal.kernel.dao.orm.QueryUtil.ALL_POS,
			com.liferay.portal.kernel.dao.orm.QueryUtil.ALL_POS, null, true);
	}
	...
	public default java.util.List<IndexEntry> findByPortletId(
		...
		return findByPortletId(portletId, start, end, null, true);
	}
	 ...
	 * @return the matching index entries
	 */
	public default java.util.List<IndexEntry> findByO_P(
		int ownerType, String portletId) {
	...
	public default java.util.List<IndexEntry> findByO_P(
		...
		return findByO_P(ownerType, portletId, start, end, null, true);
	}
	 ...
	 * @return the matching index entries
	 */
	public default java.util.List<IndexEntry> findByP_P(
		long plid, String portletId) {
	...
	public default java.util.List<IndexEntry> findByP_P(
		...
		return findByP_P(plid, portletId, start, end, null, true);
	}
	 ...
	 * @return the matching index entries
	 */
	public default java.util.List<IndexEntry> findByO_O_P(
		long ownerId, int ownerType, long plid) {
	...
	public default java.util.List<IndexEntry> findByO_O_P(
		...
		return findByO_O_P(ownerId, ownerType, plid, start, end, null, true);
	}
	 ...
	 * @return the matching index entries
	 */
	public default java.util.List<IndexEntry> findByO_O_PI(
		long ownerId, int ownerType, String portletId) {
	...
	public default java.util.List<IndexEntry> findByO_O_PI(
		...
		return findByO_O_PI(
			ownerId, ownerType, portletId, start, end, null, true);
	}
	 ...
	 * @return the matching index entries
	 */
	public default java.util.List<IndexEntry> findByO_P_P(
		int ownerType, long plid, String portletId) {
	...
	public default java.util.List<IndexEntry> findByO_P_P(
		...
		return findByO_P_P(ownerType, plid, portletId, start, end, null, true);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:1307144986