 ...
 * <code>com.liferay.portal.tools.service.builder.test.compat740.service.impl.MappingEntryLocalServiceImpl</code> and
...
public class MappingEntryLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.portal.tools.service.builder.test.compat740.service.impl.MappingEntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static boolean addBasicEntryMappingEntries(
		long basicEntryId, List<MappingEntry> mappingEntries) {

		return getService().addBasicEntryMappingEntries(
	...
	public static boolean addBasicEntryMappingEntry(
		long basicEntryId, long mappingEntryId) {

		return getService().addBasicEntryMappingEntry(
	...
	private static final Snapshot<MappingEntryLocalService> _serviceSnapshot =
		new Snapshot<>(
