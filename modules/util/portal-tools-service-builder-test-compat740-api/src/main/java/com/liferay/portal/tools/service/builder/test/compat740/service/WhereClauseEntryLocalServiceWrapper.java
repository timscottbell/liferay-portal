...
public class WhereClauseEntryLocalServiceWrapper
	...
	public <T> T dslQuery(com.liferay.petra.sql.dsl.query.DSLQuery dslQuery) {
		return _whereClauseEntryLocalService.dslQuery(dslQuery);
	}
	...
	public int dslQueryCount(
		...
		return _whereClauseEntryLocalService.dslQueryCount(dslQuery);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:-1026453854