...
public interface ERCGroupEntryPersistence
	 ...
	 * @return the matching erc group entry, or <code>null</code> if a matching erc group entry could not be found
	 */
	public default ERCGroupEntry fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching erc group entry, or <code>null</code> if a matching erc group entry could not be found
	 */
	public default ERCGroupEntry fetchByERC_G(
		String externalReferenceCode, long groupId) {
	 ...
	 */
	public default java.util.List<ERCGroupEntry> findByUuid(String uuid) {
		return findByUuid(
	 ...
	 */
	public default java.util.List<ERCGroupEntry> findByUuid(
		String uuid, int start, int end) {
	 ...
	 * @return the matching erc group entries
	 */
	public default java.util.List<ERCGroupEntry> findByUuid_C(
		String uuid, long companyId) {
...
// LIFERAY-SERVICE-BUILDER-HASH:1479295661