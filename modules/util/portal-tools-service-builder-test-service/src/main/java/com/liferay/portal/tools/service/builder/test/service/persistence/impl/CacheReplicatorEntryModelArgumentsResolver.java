...
/**
 * The arguments resolver class for retrieving value from CacheReplicatorEntry.
 *
...
@OSGiBeanProperties(
	property = {
		"class.name=com.liferay.portal.tools.service.builder.test.model.impl.CacheReplicatorEntryImpl",
		"table.name=CacheReplicatorEntry"
	},
	service = ArgumentsResolver.class
)
public class CacheReplicatorEntryModelArgumentsResolver
	...
	public Object[] getArguments(
		...
		CacheReplicatorEntryModelImpl cacheReplicatorEntryModelImpl =
			(CacheReplicatorEntryModelImpl)baseModel;

		long columnBitmask = cacheReplicatorEntryModelImpl.getColumnBitmask();
		...
		if (finderPathColumnBitmask == null) {
			...
			for (String columnName : columnNames) {
				finderPathColumnBitmask |=
					cacheReplicatorEntryModelImpl.getColumnBitmask(columnName);
			}
	...
	public String getClassName() {
		return CacheReplicatorEntryImpl.class.getName();
	}

	@Override
	public String getTableName() {
		return CacheReplicatorEntryTable.INSTANCE.getTableName();
	}
