...
public interface ExpandoColumnPersistence
	 ...
	 * @return the matching expando column, or <code>null</code> if a matching expando column could not be found
	 */
	public default ExpandoColumn fetchByT_N(long tableId, String name) {
	 ...
	 */
	public default java.util.List<ExpandoColumn> findByTableId(long tableId) {
	 ...
	 */
	public default java.util.List<ExpandoColumn> findByTableId(
		long tableId, int start, int end) {
	 ...
	 */
	public default java.util.List<ExpandoColumn> filterFindByTableId(
		long tableId) {
	 ...
	 * @return the matching expando columns
	 */
	public default java.util.List<ExpandoColumn> findByT_N(
		long tableId, String[] names) {

		return findByT_N(
			tableId, names, com.liferay.portal.kernel.dao.orm.QueryUtil.ALL_POS,
			com.liferay.portal.kernel.dao.orm.QueryUtil.ALL_POS, null, true);
	}
	...
	public default java.util.List<ExpandoColumn> findByT_N(
		...
		return findByT_N(tableId, names, start, end, null, true);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:-1001965983