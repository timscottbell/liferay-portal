...
public interface ExportImportConfigurationPersistence
	 ...
	 */
	public default java.util.List<ExportImportConfiguration> findByGroupId(
		long groupId) {
	 ...
	 * @return the matching export import configurations
	 */
	public default java.util.List<ExportImportConfiguration> findByCompanyId(
		long companyId) {
	 ...
	 * @return the matching export import configurations
	 */
	public default java.util.List<ExportImportConfiguration> findByG_T(
		long groupId, int type) {
	 ...
	 * @return the matching export import configurations
	 */
	public default java.util.List<ExportImportConfiguration> findByG_S(
		long groupId, int status) {
	 ...
	 * @return the matching export import configurations
	 */
	public default java.util.List<ExportImportConfiguration> findByG_T_S(
		long groupId, int type, int status) {
...
// LIFERAY-SERVICE-BUILDER-HASH:1851591574