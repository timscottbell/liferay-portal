...
public interface ListTypePersistence extends BasePersistence<ListType> {
	 ...
	 * @return the matching list type, or <code>null</code> if a matching list type could not be found
	 */
	public default ListType fetchByC_N_T(
	 ...
	 */
	public default java.util.List<ListType> findByUuid(String uuid) {
		return findByUuid(
	 ...
	 */
	public default java.util.List<ListType> findByUuid(
		String uuid, int start, int end) {
	 ...
	 * @return the matching list types
	 */
	public default java.util.List<ListType> findByUuid_C(
		String uuid, long companyId) {
	 ...
	 * @return the matching list types
	 */
	public default java.util.List<ListType> findByCompanyId(long companyId) {
	 ...
	 * @return the range of matching list types
	 */
	public default java.util.List<ListType> findByCompanyId(
		long companyId, int start, int end) {
	 ...
	 * @return the matching list types
	 */
	public default java.util.List<ListType> findByC_T(
		long companyId, String type) {
...
// LIFERAY-SERVICE-BUILDER-HASH:856820701