...
public interface RepositoryPersistence
	 ...
	 * @return the matching repository, or <code>null</code> if a matching repository could not be found
	 */
	public default Repository fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching repository, or <code>null</code> if a matching repository could not be found
	 */
	public default Repository fetchByG_N_P(
	 ...
	 * @return the matching repository, or <code>null</code> if a matching repository could not be found
	 */
	public default Repository fetchByERC_G(
	 ...
	 */
	public default java.util.List<Repository> findByUuid(String uuid) {
		return findByUuid(
	 ...
	 */
	public default java.util.List<Repository> findByUuid(
		String uuid, int start, int end) {
	 ...
	 * @return the matching repositories
	 */
	public default java.util.List<Repository> findByUuid_C(
		String uuid, long companyId) {
	 ...
	 * @return the matching repositories
	 */
	public default java.util.List<Repository> findByGroupId(long groupId) {
	 ...
	 * @return the range of matching repositories
	 */
	public default java.util.List<Repository> findByGroupId(
		long groupId, int start, int end) {
	 ...
	 * @return the matching repositories
	 */
	public default java.util.List<Repository> findByPortletId(
		String portletId) {
...
// LIFERAY-SERVICE-BUILDER-HASH:-214725490