...
public interface SocialActivitySettingPersistence
	 ...
	 * @return the matching social activity setting, or <code>null</code> if a matching social activity setting could not be found
	 */
	public default SocialActivitySetting fetchByG_C_A_N(
		long groupId, long classNameId, int activityType, String name) {
	 ...
	 */
	public default java.util.List<SocialActivitySetting> findByGroupId(
		long groupId) {
	 ...
	 * @return the matching social activity settings
	 */
	public default java.util.List<SocialActivitySetting> findByG_C(
		long groupId, long classNameId) {
	 ...
	 * @return the matching social activity settings
	 */
	public default java.util.List<SocialActivitySetting> findByG_A(
		long groupId, int activityType) {
	...
	public default java.util.List<SocialActivitySetting> findByG_A(
		...
		return findByG_A(groupId, activityType, start, end, null, true);
	}
	 ...
	 * @return the matching social activity settings
	 */
	public default java.util.List<SocialActivitySetting> findByG_C_A(
		long groupId, long classNameId, int activityType) {
	...
	public default java.util.List<SocialActivitySetting> findByG_C_A(
		...
		return findByG_C_A(
			groupId, classNameId, activityType, start, end, null, true);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:1201860461