...
public interface IndividualSegmentMembershipResource {
	...
	public HttpInvoker.HttpResponse
			getWorkspaceGroupIndividualSegmentMembershipsPageHttpResponse(
				Long groupId, String individualSegmentId, Pagination pagination,
				String sortString)
		throws Exception;
	...
	public static class IndividualSegmentMembershipResourceImpl
		...
		public Page<IndividualSegmentMembership>
			...
			HttpInvoker.HttpResponse httpResponse =
				getWorkspaceGroupIndividualSegmentMembershipsPageHttpResponse(
					groupId, individualSegmentId, pagination, sortString);
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/faro-rest/v1.0/workspace/{groupId}/individual-segments/{individualSegmentId}/memberships");
...
// LIFERAY-REST-BUILDER-HASH:-475686455